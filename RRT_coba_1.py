...
class RRT:
    ...
    class AreaBounds:
        ...
        def __init__ (self, area):
            ...
            self.ymin = float(area[1])
            self.xmax = float(area[2])
            self.ymax = float(area[3])

    def __init__(self, start,
                 goal, obstacle_list,
                 rand_area, expand_dis=3.0,
                 path_resolution=0.5,
                 goal_sample_rate=5, 
                 max_iter=500,
                 play_area=None
        ...
        randAre: Random sampling Area [min, max]
    ...
    def steer(self, from_node, to_node, extend_length=float("inf")):
        ...
        n_extend = math.floor(extend_length / self.path_resolution)
